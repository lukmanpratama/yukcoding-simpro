            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <img src="{{ asset('landingpage/assets/images/hero/dotted-shape.svg') }}" alt="shape"
                            class="shape shape-1" />
                        <img src="{{ asset('landingpage/assets/images/hero/dotted-shape.svg') }}" alt="shape"
                            class="shape shape-2" />
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="{{ asset('landingpage/assets/images/testimonials/author-01.png') }}"
                                    alt="author" />
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="{{ asset('landingpage/assets/images/testimonials/author-02.png') }}"
                                    alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4>Margin Gesmu</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="{{ asset('landingpage/assets/images/testimonials/author-03.png') }}"
                                    alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4>William Smith</h4>
                    ...
                    <div class="ud-brands wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="ud-brands-logo">
                            <div class="ud-single-logo">
                                <img src="{{ asset('landingpage/assets/images/brands/ayroui.svg') }}"
                                    alt="ayroui" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('landingpage/assets/images/brands/uideck.svg') }}"
                                    alt="uideck" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('landingpage/assets/images/brands/graygrids.svg') }}"
                                    alt="graygrids" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('landingpage/assets/images/brands/lineicons.svg') }}"
                                    alt="lineicons" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('landingpage/assets/images/brands/ecommerce-html.svg') }}"
                                    alt="ecommerce-html" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".1s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="{{ asset('landingpage/assets/images/team/team-01.png') }}"
                                    alt="team" />
                            </div>

                            <img src="{{ asset('landingpage/assets/images/team/dotted-shape.svg') }}" alt="shape"
                                class="shape shape-1" />
                            <img src="{{ asset('landingpage/assets/images/team/shape-2.svg') }}" alt="shape"
                                class="shape shape-2" />
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".15s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="{{ asset('landingpage/assets/images/team/team-02.png') }}"
                                    alt="team" />
                            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".2s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="{{ asset('landingpage/assets/images/team/team-03.png') }}"
                                    alt="team" />
                            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".25s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="{{ asset('landingpage/assets/images/team/team-04.png') }}"
                                    alt="team" />
                            </div>
